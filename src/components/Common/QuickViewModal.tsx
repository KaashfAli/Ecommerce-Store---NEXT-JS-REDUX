            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-5 mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <g clipPath="url(#clip0_375_9221)">
                      <path
                        ...
                        fill={product.quantity === 0 ? "#E11D48" : "#22AD5C"}
                      />
                      {product.quantity !== 0 && (
                        <path
                      ...
                      {product.quantity === 0 && (
                        <path
                          d="M12.6875 7.09374L7.09375 12.6875M7.09375 7.09374L12.6875 12.6875"
                          stroke="#E11D48"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                        />
                  ...
                  <span className={`font-medium ${product.quantity === 0 ? "text-red-600" : "text-dark"}`}>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className={`inline-flex font-medium py-3 px-7 rounded-md ease-out duration-200 ${product.quantity === 0 || quantity === 0
                    ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                    : "text-white bg-blue hover:bg-blue-dark cursor-pointer"
                    }`}
                >
                  Add to Cart
                </button>
