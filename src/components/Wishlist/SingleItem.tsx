  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-10">
      ...
      <div className="min-w-[205px]">
        <p className="text-dark">Rs {item.discountedPrice}</p>
      </div>
      ...
      <div className="min-w-[150px] flex justify-end">
        <button
          ...
          className={`inline-flex py-2.5 px-6 rounded-md ease-out duration-200 border ${item.stock === 0
            ? "bg-gray-2 text-gray-4 border-gray-3 cursor-not-allowed"
            : "text-dark hover:text-white bg-gray-1 border-gray-3 hover:bg-blue hover:border-blue cursor-pointer"
            }`}
        >
          Add to Cart
        </button>
